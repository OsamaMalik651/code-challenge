...
const SearchBar = ({ searchTerm, setSearchTerm, maxPosts }) => {
    ...
    return (
        <div className="flex max-w-fit gap-10 justify-center rounded-md shadow-md p-4 justify-self-center">
            <input
                className='flex-initial w-96 h-12 border-solid border-2 rounded-md px-4 focus:outline-none'
            ...
            />
            <button
                className='border-2 border-solid border-black rounded-md p-2 pl-4 pr-4 font-bold active:bg-black active:text-white'
